...
namespace UnityOrbisBridge
{
    internal static class PrivateImports
    {
        ...
        [DllImport("UnityOrbisBridge")] public static extern IntPtr GetDiskInfo(string infoType, string mountPoint = "/user");
        #endregion
    ...
    public static partial class UOB
    {
        ...
        [DllImport("UnityOrbisBridge")] public static extern int InstallLocalPackageWithResult(string filePath, string name, string iconURI, bool deleteAfter);
